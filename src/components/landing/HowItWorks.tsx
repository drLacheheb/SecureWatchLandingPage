    ...
    return (
        <section id="how-it-works" className="py-24 bg-zinc-950 relative border-t border-zinc-900 overflow-hidden">
            ...
            <div className="container max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-24 relative">
                ...
                <div className="relative h-[400px] lg:h-full lg:min-h-[500px] lg:mt-0 order-1 lg:order-2">
                    <div className="sticky top-32 w-full aspect-square rounded-2xl overflow-hidden p-8">
