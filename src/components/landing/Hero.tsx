    ...
    return (
        <section className="relative grid place-items-center min-h-[calc(100vh-4rem)] content-center overflow-hidden py-12 md:py-24">
            ...
            <div className="container max-w-5xl mx-auto px-4 flex flex-col items-center text-center gap-8">
                ...
                >
                    <Badge variant="outline" className="border-emerald-500/30 text-emerald-400 bg-emerald-500/5 px-4 py-2 text-lg">
                ...
                {/* Animated Headline */}
                <motion.h1
                    className="text-3xl md:text-7xl font-extrabold tracking-tight text-white max-w-4xl"
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
